...
(13, 'Lantern', 'Jack\'O', 'j.lantern@atlus.com', '$2y$10$wUTi.dgKpOKb88X1dp11qONC8N6V6X/VmXBgmYiGvmwbC6phEQjzq', NULL, NULL);
...
(3, 'Frost', 'Queen', 'q.frost@atlus.com', '$2y$10$ny1KVESJGckBYFRjafmGt.WzOPFt4A/WM5zy6ruZWvyU8B6VmNC7a', NULL, NULL);
...
CREATE TABLE `remember_tokens` (
  ...
  `user_type` enum('eleve','formateur','administrateur') NOT NULL,
...
--
ALTER TABLE `eleve`
  MODIFY `id_eleve` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
