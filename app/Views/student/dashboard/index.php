...
<div class="d-flex" style="min-height: calc(100vh - 56px);">
    ...
    <nav id="studentSidebar" class="d-flex flex-column p-3 text-white"
         style="width: 240px; min-width: 240px; background-color: #1e1e2e;">

        <div class="mb-4 mt-2">
            <span class="fw-bold fs-5" style="color: #e8630a;">&#9679; Étudiant</span>
        </div>
        ...
        <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link sidebar-link" data-section="notes"
                   style="color: #ccc; border-radius: 6px;">
                    Mes notes
                </a>
            </li>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center mb-4 gap-3">
                            ...
                            <div>
                                ...
                                <span class="badge text-white" style="background-color: #e8630a;">Étudiant</span>
                            </div>
                        </div>
                        ...
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-semibold">Étudiant</td>
                                </tr>
                            </tbody>
                        </table>
...
<script src="<?= base_url('js/dashboard/student_dashboard.js') ?>"></script>
