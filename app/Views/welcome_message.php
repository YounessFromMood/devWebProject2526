...
<head>
    <meta charset="UTF-8">
    <title>Welcôme tou Kôde Initeur 4!</title>
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcôme tou Kôde Initeur <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2>De smaule frèmworq wiz pauweurfoull fiturz</h2>
        <h2>On ne se prends pas la grape huhu</h2>
...
<section>
    ...
    <h1>Eubowt disse paij</h1>

    <p>De paij iou arr loukinegue atte iz biing généraiytéde daïnamicaulie baïy Kôde Initeur.</p>

    <p>Ife iou woud laïke tou édite diz paij iou wile faïnde ite locaitede ate:</p>

    <pre><code>app/Views/welcome_message.php</code></pre>

    <p>De corespoundingue contrôleure fore diz paij caine bi founde ate:</p>

    <pre><code>app/Controllers/Home.php</code></pre>

    <p>Merci pour ces infos drare</p>
    <a href="/devwebProject2526/details">Les détails!!!</a>
    <a href="/devwebProject2526/details">Les détails!!!</a>
