...
function loadSection(section, link) {
    ...
    const urls = {
        'sessions'   : BASE_URL + 'student/dashboard/my-course',
        'historique' : BASE_URL + 'student/history',
        'notes'      : BASE_URL + 'student/grades',
        'planning'   : BASE_URL + 'student/dashboard/planning',
    };
    ...
    .then(html => {
        ...
        if (section === 'planning') {
            ...
            script.src = BASE_URL + 'js/student/planning.js?v=' + ASSET_VERSION;
