document.addEventListener('click', function (e) {
    ...
    if (e.target.id === 'btnConfirmSaveLink') {
        ...
        const url = ancienLieu
            ? `${BASE_URL}teacher/session/link/modify-link/${idSession}`
            : `${BASE_URL}teacher/session/link/add-link/${idSession}`;
    ...
    if (e.target.id === 'btnDeleteLink') {
        ...
        fetch(`${BASE_URL}teacher/session/link/delete-link/${idSession}`, {
            method  : 'POST',
